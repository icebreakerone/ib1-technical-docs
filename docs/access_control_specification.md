...
A licence interpretation which only contains the URL of the legal text withindoes not contain any Grants or Obligations is valid.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1NjgzODc0Miw4OTY1NjUxMTAsMTIwMz
