...
[Data Providers](../glossary.md#term-Data-Provider) are responsible for the correctness of data returned by their published data [APIs](../glossary.md#term-Application-programming-interface). [Open Net Zero](https://opennetzero.org) provides a mechanism (a flag at the top-right of the page for the dataset) by which [Data Consumers](../glossary.md#term-Data-Consumer) can report any data quality issues to Icebreaker One, which will be forwarded to a nominated contact within the [Data Provider](../glossary.md#term-Data-Provider).
...
The deprecation of unsupported versions is at the [Data Provider](../glossary.md#term-Data-Provider)’s discretion – based on usage metrics. However, the [TFGS](../glossary.md#term-Trust-Framework-Governance-Service) may recommend that any specific version (major, minor, or patch) should be deprecated at any time, and this should be implemented within three months of notification by the [TFGS](../glossary.md#term-Trust-Framework-Governance-Service). This is to cater for critical defects, especially those relating to security. In exceptional circumstances it may be agreed by [TFGS](../glossary.md#term-Trust-Framework-Governance-Service) that support for a specific version is terminated earlier.
